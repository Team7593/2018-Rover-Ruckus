...
/**
 * Created by vineelavandanapu on 1/3/18.
 *
 * New Hardware class for the newest model of the robot. Nearly identical to the old class,
 * which has been refactored and renamed to Hardware.
 *
 * edit: Hardware doesn't exist anymore lol
 *
 * YO DOMI Ignore the stuff up there
 * so here's where you'd change values for the tilt servo
 * just look for comments that say hey domi and you're good to go
 */
...
public class Team7593Hardware {
    ...
    public final static double EXTENSION_HOME = 0.0; //starting position for servo tilt
    public final static double EXTENSION_MIN = 0.0; //min value for servo tilt
    public final static double EXTENSION_MAX = 1; //max value for servo tilt
